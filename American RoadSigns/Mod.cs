...
namespace AmericanRoadSigns
{
    public class Mod : IUserMod
    {
        ...
        {
            AmericanRoadsignsTool.config.enable_localassets = c;
            AmericanRoadsignsTool.SaveConfig();
        }
        ...
        public void OnSettingsUI(UIHelperBase helper)
        {
            try
            {
                ...
                group.AddSpace(10);
                //  Toggle Options (Misc.):
                group.AddCheckbox("Load dependencies from local mod folder, if present", AmericanRoadsignsTool.config.enable_localassets, new OnCheckChanged(OnEnableLocalAssetsChanged));
